...
// 下位コンポーネント（各モーダル）
import EndpointsModal from "@/PokemonCards01/components/Modal/EndpointsModal";
import ExplanationModal from "@/PokemonCards01/components/Modal/ExplanationModal";
import SearchModal from "@/PokemonCards01/components/Modal/SearchModal";
import LinksModal from "@/PokemonCards01/components/Modal/LinksModal";
