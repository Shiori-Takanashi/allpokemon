...
// 下位コンポーネント（各モーダル）
import EndpointsModal from "@/PokemonCards/components/Modal/EndpointsModal";
import ExplanationModal from "@/PokemonCards/components/Modal/ExplanationModal";
import SearchModal from "@/PokemonCards/components/Modal/SearchModal";
import LinksModal from "@/PokemonCards/components/Modal/LinksModal";
